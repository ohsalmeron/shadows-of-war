                        ...
                        Ok(client) => {
                            ...
                            if self.ui.app.phase == sow_ui::app::ClientPhase::Playing {
                                ...
                                let join_msg = sow_core::protocol::ClientMessage::Join {
                                    ...
                                    is_observer: false,
                                    target_lobby_id: self.sim.my_lobby_id.or(self.ui.app.main_menu_state.pending_join_lobby_id),
                    ...
                    if !ws_disconnected {
                        ...
                        match server_msg {
                            ...
                            ServerMessage::SyncState(sync_msg) => {
                                ...
                                if self.ui.app.main_menu_state.is_waiting {
                                    ...
                                    if sync_msg.is_starting {
                                        ...
                                        if let Some(id) = key {
                                            if let Some(lobby) = self.ui.app.main_menu_state.lobbies.iter_mut().find(|l| l.id == id) {
                                                ...
                                                self.ui.app.main_menu_state.lobbies.push(sow_core::protocol::LobbyInfo {
                                                    id,
                            ...
                            ServerMessage::LobbiesBroadcast(broadcast) => {
                                ...
                                let (thumbs_to_fetch, maps_to_fetch) = self.ui.app.asset_loader.get_assets_to_fetch(&self.ui.app.main_menu_state.lobbies);
