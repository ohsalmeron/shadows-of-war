//! GENERATED by `./sow ui` export from `assets/editor/ui/demo.json` — do not edit by hand.
        ...
        .show(ctx, |ui| {
            ...
            theme::hud_panel_frame().show(ui, |ui| {
                ...
                ui.vertical_centered(|ui| {
                    ...
                    ui.add_space(6.0);
                    ui.label(
                        RichText::new("Authored as JSON · generated by ./sow ui")
                            .size(12.0)
