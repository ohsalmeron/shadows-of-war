...
pub(super) struct RenderedBuilding {
    pub bx: f32, pub by: f32, pub kind: BuildingKind,
    pub active_level: u8, pub target_level: u8,
    pub under_construction: bool, pub ticks_until_complete: u32,
    pub count: usize, pub owner_id: u16,
    pub id: Option<u64>,
...
pub(super) fn collect_rendered_buildings(
    snap: &sow_core::protocol::SimSnapshot, map_w: u32,
    zoom_scaled: f32, far_zoom_threshold: f32,
