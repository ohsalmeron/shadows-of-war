...
pub(super) fn paint_building_overlays(
    ui: &mut crate::app::UiState, _sim: &crate::app::SimState,
    ...
    center: egui::Pos2, base_size: f32, zoom_scaled: f32, final_scale: f32,
    sf: f32, hovered_tile_idx: Option<u32>, player_colors: &[egui::Color32],
) {
