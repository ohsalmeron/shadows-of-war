                        ...
                        if let Some(ref mut s) = self.gfx.surface {
                            ...
                            if let Some(ref mut mr) = self.gfx.map_renderer {
                                ...
                                self.ui.egui_ctx.data_mut(|d| {
                                    ...
                                    shore_thickness = *d.get_temp_mut_or_insert_with(egui::Id::new("dev_shore_thickness"), || 0.12f32);
                            ...
                            if !map_drawn {
                                let pass = self.gfx.render_ctx.command_encoder.render("clear_pass", gpu::RenderTargetSet {
