    ...
    pub(super) fn render_dev_sidebar(&mut self, _ctx: &egui::Context, ui: &mut egui::Ui) {
        ...
        ui.vertical(|ui| {
            ...
            ui.collapsing(RichText::new("Map & Borders").strong().size(11.5).color(Color32::WHITE), |ui| {
                ...
                ui.add(egui::Slider::new(&mut cfg.shore_thickness, 0.0..=1.0).text("Shore Thk"));
                ui.add(egui::Slider::new(&mut cfg.conquest_duration, 0.1..=10.0).text("Conquest Dur"));
                ui.add(egui::Slider::new(&mut cfg.territory_opacity, 0.0..=1.0).text("Opacity"));
            ...
            ui.collapsing(RichText::new("Custom HUD Theme").strong().size(11.5).color(Color32::WHITE), |ui| {
                ...
                ui.add(egui::Slider::new(&mut cfg.theme_outline_thickness, 0.0..=10.0).text("Outline Thk"));
                ui.add(egui::Slider::new(&mut cfg.theme_glow_spread, 0.0..=4.0).text("Glow Spread"));
                ui.add(egui::Slider::new(&mut cfg.theme_glow_thickness, 0.0..=5.0).text("Glow Thk"));
                ui.horizontal(|ui| {
                    ui.label("Top Color:");
            ...
            ui.collapsing(RichText::new("Font Settings (SDF)").strong().size(11.5).color(Color32::WHITE), |ui| {
                ui.add(egui::Slider::new(&mut cfg.font_size_scale, 0.5..=2.5).text("Font Size"));
                ui.add(egui::Slider::new(&mut cfg.font_face_dilate, -1.0..=2.0).text("Face Dilate"));
                ui.add(egui::Slider::new(&mut cfg.font_outline_thickness, 0.0..=3.0).text("Outline"));
                ui.add(egui::Slider::new(&mut cfg.font_shadow_y, 0.0..=5.0).text("Shadow Y"));
                ui.add(egui::Slider::new(&mut cfg.font_underlay_softness, 0.0..=2.0).text("Softness"));
                ui.add(egui::Slider::new(&mut cfg.font_char_spacing, 0.8..=1.8).text("Spacing"));
                ui.add(egui::Slider::new(&mut cfg.font_offset_x, -16.0..=16.0).text("Offset X"));
            ...
            ui.collapsing(RichText::new("Building Settings").strong().size(11.5).color(Color32::WHITE), |ui| {
                ...
                ui.add(egui::Slider::new(&mut cfg.emoji_size_scale, 0.5..=3.0).text("Emoji Size"));
            ...
            ui.separator();
            ui.collapsing(RichText::new("Objectives Bar").strong().size(11.5).color(Color32::WHITE), |ui| {
                ui.horizontal(|ui| {
                    ui.label("Filler Top:");
            ...
            ui.collapsing(RichText::new("Bunker Laser").strong().size(11.5).color(Color32::WHITE), |ui| {
                ui.add(egui::Checkbox::new(&mut cfg.bunker_laser_target, "Target seeking"));
                ui.add(egui::Checkbox::new(&mut cfg.bunker_laser_arc, "Plasma arc"));
                ui.add(egui::Checkbox::new(&mut cfg.bunker_laser_scatter, "Volley scatter"));
