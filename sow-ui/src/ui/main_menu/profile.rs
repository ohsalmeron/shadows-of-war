...
pub fn draw_user_profile_header(
    ...
    // Fixed right padding for the entire parent component to leave a gap with the viewport
    let right_padding = 8.0;
    let desired_width = ui.available_width() - right_padding;
    let frame_height = profile_height - 12.0;
    ...
    // Allocate exact UI width to leave a right-hand margin gap in the viewport
    ui.allocate_ui(egui::vec2(desired_width, frame_height), |ui| {
