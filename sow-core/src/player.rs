...
pub static PREMIUM_COLORS: [NamedColor; 300] = [
    ...
    NamedColor { name: "Rome Crimson", rgb: [0.75, 0.15, 0.18] },
    NamedColor { name: "Egypt Gold", rgb: [0.85, 0.65, 0.15] },
    NamedColor { name: "Vikings Blue", rgb: [0.15, 0.35, 0.65] },
    NamedColor { name: "China Jade", rgb: [0.15, 0.55, 0.42] },
    NamedColor { name: "Macedon Blue", rgb: [0.22, 0.45, 0.78] },
    NamedColor { name: "Mongol Bronze", rgb: [0.55, 0.42, 0.22] },
    NamedColor { name: "Angevin Crimson", rgb: [0.72, 0.18, 0.15] },
    NamedColor { name: "Gallic Green", rgb: [0.28, 0.52, 0.22] },
    NamedColor { name: "Iceni Orange", rgb: [0.88, 0.42, 0.12] },
    NamedColor { name: "Maya Teal", rgb: [0.12, 0.58, 0.52] },
    NamedColor { name: "Sparta Bronze", rgb: [0.62, 0.42, 0.22] },
    NamedColor { name: "France Blue", rgb: [0.18, 0.28, 0.68] },

    // --- The Green Sanctuary (70 Colors) ---
    NamedColor { name: "Cyber Neon Green", rgb: hex_to_rgb(0x00FF66) },
    NamedColor { name: "Neon Lime", rgb: hex_to_rgb(0x39FF14) },
    NamedColor { name: "Teal Wave", rgb: hex_to_rgb(0x1FCECB) },
    NamedColor { name: "Classic Teal", rgb: hex_to_rgb(0x008080) },
    NamedColor { name: "Sea Green", rgb: hex_to_rgb(0x2E8B57) },
    NamedColor { name: "Spring Green", rgb: hex_to_rgb(0x00FF7F) },
    NamedColor { name: "Chartreuse", rgb: hex_to_rgb(0x7FFF00) },
    NamedColor { name: "Lawn Green", rgb: hex_to_rgb(0x7CFC00) },
    NamedColor { name: "Green Yellow", rgb: hex_to_rgb(0xADFF2F) },
    NamedColor { name: "Pale Green", rgb: hex_to_rgb(0x98FB98) },
    NamedColor { name: "Electric Lime", rgb: hex_to_rgb(0x00FF00) },
    NamedColor { name: "Lime Green", rgb: hex_to_rgb(0x32CD32) },
    NamedColor { name: "Forest Green", rgb: hex_to_rgb(0x228B22) },
    NamedColor { name: "Dark Green", rgb: hex_to_rgb(0x006400) },
    NamedColor { name: "Dark Olive Green", rgb: hex_to_rgb(0x556B2F) },
    NamedColor { name: "Olive Drab", rgb: hex_to_rgb(0x6B8E23) },
    NamedColor { name: "Yellow Green", rgb: hex_to_rgb(0x9ACD32) },
    NamedColor { name: "Light Sea Green", rgb: hex_to_rgb(0x20B2AA) },
    NamedColor { name: "Medium Sea Green", rgb: hex_to_rgb(0x3CB371) },
    NamedColor { name: "Dark Sea Green", rgb: hex_to_rgb(0x8FBC8F) },
    NamedColor { name: "Medium Aquamarine", rgb: hex_to_rgb(0x66CDAA) },
    NamedColor { name: "Deep Sea Green", rgb: hex_to_rgb(0x458B74) },
    ...
    NamedColor { name: "Pistachio", rgb: hex_to_rgb(0x93C572) },
    NamedColor { name: "Persian Green", rgb: hex_to_rgb(0x17B890) },
    NamedColor { name: "Viridian", rgb: hex_to_rgb(0x40826D) },
    NamedColor { name: "Laurel Green", rgb: hex_to_rgb(0x00A572) },
    NamedColor { name: "Clover", rgb: hex_to_rgb(0x0B6623) },
    NamedColor { name: "Eucalyptus", rgb: hex_to_rgb(0x4A5D4E) },
    NamedColor { name: "Dark Slate", rgb: hex_to_rgb(0x2F4F4F) },
    NamedColor { name: "Olive", rgb: hex_to_rgb(0x808000) },
    ...
    NamedColor { name: "Artichoke", rgb: hex_to_rgb(0x8F9779) },
    NamedColor { name: "Asparagus", rgb: hex_to_rgb(0x87A96B) },
    NamedColor { name: "Avocado", rgb: hex_to_rgb(0x568203) },
    NamedColor { name: "Basil", rgb: hex_to_rgb(0x828E84) },
    NamedColor { name: "Celadon", rgb: hex_to_rgb(0xACE1AF) },
    NamedColor { name: "Feldgrau", rgb: hex_to_rgb(0x4D5D53) },
    NamedColor { name: "Hooker's Green", rgb: hex_to_rgb(0x49796B) },
    NamedColor { name: "Hunter Green", rgb: hex_to_rgb(0x355E3B) },
    NamedColor { name: "Itten's Green", rgb: hex_to_rgb(0x00A859) },
    NamedColor { name: "Kelly Green", rgb: hex_to_rgb(0x4CBB17) },
    ...
    NamedColor { name: "Classic Purple", rgb: hex_to_rgb(0x800080) },
    NamedColor { name: "Blue Violet", rgb: hex_to_rgb(0x8A2BE2) },
    NamedColor { name: "Dark Violet", rgb: hex_to_rgb(0x9400D3) },
    NamedColor { name: "Dark Orchid", rgb: hex_to_rgb(0x9932CC) },
    NamedColor { name: "Medium Orchid", rgb: hex_to_rgb(0xBA55D3) },
    NamedColor { name: "Orchid Pink", rgb: hex_to_rgb(0xDA70D6) },
    NamedColor { name: "Lavender Blush", rgb: hex_to_rgb(0xEE82EE) },
    NamedColor { name: "Thistle", rgb: hex_to_rgb(0xD8BFD8) },
    NamedColor { name: "Electric Fuchsia", rgb: hex_to_rgb(0xFF00FF) },
    NamedColor { name: "Medium Violet Red", rgb: hex_to_rgb(0xC71585) },
    NamedColor { name: "Deep Hot Pink", rgb: hex_to_rgb(0xFF1493) },
    NamedColor { name: "Bubblegum Pink", rgb: hex_to_rgb(0xFF69B4) },
    NamedColor { name: "Indigo Abyss", rgb: hex_to_rgb(0x4B0082) },
    NamedColor { name: "Dark Slate Blue", rgb: hex_to_rgb(0x483D8B) },
    NamedColor { name: "Medium Slate Blue", rgb: hex_to_rgb(0x7B68EE) },
    NamedColor { name: "Royal Violet", rgb: hex_to_rgb(0x6A0DAD) },
    NamedColor { name: "Burgundy Wine", rgb: hex_to_rgb(0x800020) },
    NamedColor { name: "Wine Rose", rgb: hex_to_rgb(0x722F37) },
    NamedColor { name: "Cyberpunk Magenta", rgb: hex_to_rgb(0xDA1884) },
    NamedColor { name: "Ruby Velvet", rgb: hex_to_rgb(0xE0115F) },
    NamedColor { name: "Cerise Cherry", rgb: hex_to_rgb(0xDE3163) },
    NamedColor { name: "Wisteria", rgb: hex_to_rgb(0x7A4F80) },
    ...
    NamedColor { name: "Deep Velvet Rose", rgb: hex_to_rgb(0xD10056) },
    // Expanded Cosmic
    ...
    NamedColor { name: "Solar Flare", rgb: hex_to_rgb(0xFF4500) },
    NamedColor { name: "Lunar Dust", rgb: hex_to_rgb(0xC0C0C0) },
    NamedColor { name: "Cosmic Dust", rgb: hex_to_rgb(0x4B3621) },
    ...
    NamedColor { name: "Steel Blue", rgb: hex_to_rgb(0x4682B4) },
    NamedColor { name: "Cadet Blue", rgb: hex_to_rgb(0x5F9EA0) },
    NamedColor { name: "Aqua Cyan", rgb: hex_to_rgb(0x00FFFF) },
    NamedColor { name: "Pale Turquoise", rgb: hex_to_rgb(0xE0FFFF) },
    NamedColor { name: "Pale Blue-Green", rgb: hex_to_rgb(0xAFEEEE) },
    NamedColor { name: "Aquamarine", rgb: hex_to_rgb(0x7FFFD4) },
    NamedColor { name: "Turquoise Wave", rgb: hex_to_rgb(0x40E0D0) },
    NamedColor { name: "Dark Turquoise", rgb: hex_to_rgb(0x00CED1) },
    ...
    NamedColor { name: "Surf Spray", rgb: hex_to_rgb(0x00FFFF) },
    NamedColor { name: "Tropical Lagoon", rgb: hex_to_rgb(0x20B2AA) },
    NamedColor { name: "Pacific Blue", rgb: hex_to_rgb(0x1CA9C9) },
    NamedColor { name: "Atlantic Navy", rgb: hex_to_rgb(0x002366) },
    NamedColor { name: "Indian Azure", rgb: hex_to_rgb(0x007FFF) },
    NamedColor { name: "Arctic Ice", rgb: hex_to_rgb(0xE0FFFF) },
    NamedColor { name: "Deep Sea Kelp", rgb: hex_to_rgb(0x2E8B57) },
    NamedColor { name: "Viking Fjord", rgb: hex_to_rgb(0x00A86B) },
    NamedColor { name: "Mediterranean Mist", rgb: hex_to_rgb(0x87CEEB) },
    NamedColor { name: "Baltic Steel", rgb: hex_to_rgb(0x4682B4) },
    NamedColor { name: "Caribbean Cyan", rgb: hex_to_rgb(0x00FFFF) },
    NamedColor { name: "Coral Sea", rgb: hex_to_rgb(0xFF7F50) },

    // --- The Sun & Hearth (30 Colors) ---
    NamedColor { name: "Crimson Fire", rgb: hex_to_rgb(0xFF0000) },
    NamedColor { name: "Blaze Orange", rgb: hex_to_rgb(0xFF4500) },
    NamedColor { name: "Dark Amber", rgb: hex_to_rgb(0xFF8C00) },
    NamedColor { name: "Sun Yellow", rgb: hex_to_rgb(0xFFA500) },
    NamedColor { name: "Neon Yellow", rgb: hex_to_rgb(0xFFFF00) },
    NamedColor { name: "Imperial Gold", rgb: hex_to_rgb(0xFFD700) },
    NamedColor { name: "Dark Goldenrod", rgb: hex_to_rgb(0xB8860B) },
    NamedColor { name: "Peru Tan", rgb: hex_to_rgb(0xCD853F) },
    NamedColor { name: "Chocolate Earth", rgb: hex_to_rgb(0xD2691E) },
    NamedColor { name: "Saddle Brown", rgb: hex_to_rgb(0x8B4513) },
    NamedColor { name: "Sienna Dust", rgb: hex_to_rgb(0xA0522D) },
    NamedColor { name: "Rosy Gold", rgb: hex_to_rgb(0xBC8F8F) },
    NamedColor { name: "Dark Salmon", rgb: hex_to_rgb(0xE9967A) },
    // Expanded Sun/Hearth
    NamedColor { name: "Phoenix Feather", rgb: hex_to_rgb(0xFF4F00) },
    ...
    NamedColor { name: "Autumn Leaf", rgb: hex_to_rgb(0xD94D1A) },
    NamedColor { name: "Burnt Sienna", rgb: hex_to_rgb(0xE97451) },
    NamedColor { name: "Campfire Ember", rgb: hex_to_rgb(0xFF8C00) },
    NamedColor { name: "Copper Penny", rgb: hex_to_rgb(0xAD6F44) },
    NamedColor { name: "Desert Rose", rgb: hex_to_rgb(0xEDC9AF) },
    NamedColor { name: "Fired Brick", rgb: hex_to_rgb(0xB22222) },
    NamedColor { name: "Garnet", rgb: hex_to_rgb(0x733632) },
    NamedColor { name: "Ignited Gold", rgb: hex_to_rgb(0xFFD700) },
    NamedColor { name: "Lava Flow", rgb: hex_to_rgb(0xCF1020) },

    // --- Desert Mirage (25 Colors) ---
    NamedColor { name: "Sahara Sand", rgb: hex_to_rgb(0xF4A460) },
    NamedColor { name: "Mojave Dust", rgb: hex_to_rgb(0xC2B280) },
    NamedColor { name: "Canyon Shadow", rgb: hex_to_rgb(0xA0522D) },
    ...
    NamedColor { name: "Arid Bone", rgb: hex_to_rgb(0xF5F5DC) },
    NamedColor { name: "Cactus Flower", rgb: hex_to_rgb(0xFF00FF) },
    NamedColor { name: "Prickly Pear", rgb: hex_to_rgb(0x568203) },
    NamedColor { name: "Dry Wash", rgb: hex_to_rgb(0x808080) },
    NamedColor { name: "Tumbleweed", rgb: hex_to_rgb(0xDEB887) },
    NamedColor { name: "Sedona Sunset", rgb: hex_to_rgb(0xCC7722) },
    NamedColor { name: "Painted Desert", rgb: hex_to_rgb(0xCD5C5C) },
    NamedColor { name: "Gila Monster", rgb: hex_to_rgb(0xFF8C00) },
    NamedColor { name: "Yucca", rgb: hex_to_rgb(0x2E8B57) },
    NamedColor { name: "Sage Scrub", rgb: hex_to_rgb(0x8A9A5B) },
    NamedColor { name: "Heat Haze", rgb: hex_to_rgb(0xE6E6FA) },
    NamedColor { name: "Adobe Clay", rgb: hex_to_rgb(0xD2691E) },
    NamedColor { name: "Copper Canyon", rgb: hex_to_rgb(0xB87333) },
    NamedColor { name: "Dust Devil", rgb: hex_to_rgb(0xBC8F8F) },
    NamedColor { name: "Golden Oasis", rgb: hex_to_rgb(0xFFD700) },

    // --- Frozen Tundra (25 Colors) ---
    NamedColor { name: "Arctic Fox", rgb: hex_to_rgb(0xF0F8FF) },
    NamedColor { name: "Glacial Blue", rgb: hex_to_rgb(0xAFEEEE) },
    NamedColor { name: "Aurora Teal", rgb: hex_to_rgb(0x00FFFF) },
    NamedColor { name: "Permafrost", rgb: hex_to_rgb(0xB0C4DE) },
    NamedColor { name: "Snow Drift", rgb: hex_to_rgb(0xFFFAFA) },
    NamedColor { name: "Icy Peak", rgb: hex_to_rgb(0xE0FFFF) },
    NamedColor { name: "Polar Bear", rgb: hex_to_rgb(0xFFFFFF) },
    NamedColor { name: "Frozen Lake", rgb: hex_to_rgb(0x87CEEB) },
    NamedColor { name: "Midnight Sun", rgb: hex_to_rgb(0xFFD700) },
    NamedColor { name: "Winter Twilight", rgb: hex_to_rgb(0x483D8B) },
    NamedColor { name: "Hoarfrost", rgb: hex_to_rgb(0xDCDCDC) },
    NamedColor { name: "Blizzard White", rgb: hex_to_rgb(0xF8F8FF) },
    NamedColor { name: "Crystal Ice", rgb: hex_to_rgb(0xB0E0E6) },
    NamedColor { name: "Boreal Green", rgb: hex_to_rgb(0x006400) },
    NamedColor { name: "Tundra Moss", rgb: hex_to_rgb(0x8FBC8F) },
    NamedColor { name: "Frostbite", rgb: hex_to_rgb(0xADD8E6) },
    NamedColor { name: "Sleet Grey", rgb: hex_to_rgb(0x708090) },
    ...
    NamedColor { name: "Sandstone", rgb: hex_to_rgb(0xF4A460) },
    NamedColor { name: "Pumice", rgb: hex_to_rgb(0xDCDCDC) },
    NamedColor { name: "Core Fire", rgb: hex_to_rgb(0xFF4500) },

    // --- Floral Bloom (18 Colors) ---
    NamedColor { name: "Hibiscus Red", rgb: hex_to_rgb(0xFF2400) },
    NamedColor { name: "Cherry Blossom", rgb: hex_to_rgb(0xFFB7C5) },
    NamedColor { name: "Orchid Bloom", rgb: hex_to_rgb(0xDA70D6) },
    NamedColor { name: "Lavender Mist", rgb: hex_to_rgb(0xE6E6FA) },
    NamedColor { name: "Daffodil Yellow", rgb: hex_to_rgb(0xFFFF31) },
    NamedColor { name: "Peony Pink", rgb: hex_to_rgb(0xFFC1CC) },
    NamedColor { name: "Rose Petal", rgb: hex_to_rgb(0xFF033E) },
    NamedColor { name: "Sunflower", rgb: hex_to_rgb(0xFFDA03) },
    NamedColor { name: "Iris Purple", rgb: hex_to_rgb(0x5A4FCF) },
    NamedColor { name: "Tulip Orange", rgb: hex_to_rgb(0xFF8C00) },
    NamedColor { name: "Bluebell", rgb: hex_to_rgb(0xA2A2D0) },
    NamedColor { name: "Poppy Red", rgb: hex_to_rgb(0xE35D6A) },
    NamedColor { name: "Violet", rgb: hex_to_rgb(0x8F00FF) },
    NamedColor { name: "Lily White", rgb: hex_to_rgb(0xFFFFF0) },
    NamedColor { name: "Marigold", rgb: hex_to_rgb(0xEAA221) },
    NamedColor { name: "Cornflower Blue", rgb: hex_to_rgb(0x6495ED) },
    NamedColor { name: "Hydrangea", rgb: hex_to_rgb(0x8396D1) },
    NamedColor { name: "Snapdragon", rgb: hex_to_rgb(0xFFD700) },
];
...
pub fn display_name(id: u16, name: &str, player_type: PlayerType) -> String {
    if name.is_empty() {
        match player_type {
            PlayerType::Bot => format!("{} Tribe {}", tribe_animal(id, name), id.saturating_sub(199)),
